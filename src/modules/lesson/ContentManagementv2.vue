      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <label>Audio</label>
            <br>
            <input type="text" name="title" class="form-control" v-bind:placeholder="modalContent.audio" v-model="modalContentInput.audio">
            <br> 
            ...
            <br>
            <input type="text" name="title" class="form-control" v-bind:placeholder="modalContent.syllabus_audio" v-model="modalContentInput.syllabusAudio">
          </div>
...
export default {
  ...
  methods: {
    ...
    updateContent(){
      ...
      if(this.modalContentInput.audio !== null){
        formData.append('syllabus', this.modalContentInput.audio)
      }
      if(this.modalContentInput.syllabus !== null){
        formData.append('syllabus', this.modalContentInput.syllabus)
      }
      if(this.modalContentInput.syllabusAudio !== null){
        formData.append('syllabus', this.modalContentInput.syllabusAudio)
      }else{
        //
      }
      axios.post(CONFIG.BACKEND_URL + '/content/update', formData).then(response => {
        if(response.data.error.status === 100){
          let error = response.data.error.message
          if(error.word !== 'undefined'){
            this.errorMessage = error.word[0]
