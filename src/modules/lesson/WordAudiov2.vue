        ...
        <div class="modal-content">
          <div class="modal-header bg-primary">
            ...
            <div class="modal-body">
              ...
              <br>
              <input type="text" name="title" class="form-control" v-bind:placeholder="modalAudio.audio" v-model="modalAudioInput.audio">
              <br>
              ...
              <br>
              <input type="text" name="title" class="form-control" v-bind:placeholder="modalAudio.syllabus_audio" v-model="modalAudioInput.syllabusAudio">
              <br>
...
export default {
  ...
  methods: {
    ...
    updateWord(){
      ...
      if(this.modalAudioInput.audio !== null){
        formData.append('audio', this.modalAudioInput.audio)
      }
      if(this.modalAudioInput.syllabus !== null){
        formData.append('syllabus', this.modalAudioInput.syllabus)
      }
      if(this.modalAudioInput.syllabusAudio !== null){
        formData.append('syllabus_audio', this.modalAudioInput.syllabusAudio)
      }else{
        //
      }
