      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <label>Title</label>
            <br>
            <input type="text" name="title" class="form-control" v-bind:placeholder="updateModalSentence.original" v-model="updateModalSentenceInput.original">
            <br>
            <label>Translation</label>
            <br>
            <input type="text" name="title" class="form-control" v-bind:placeholder="updateModalSentence.translation" v-model="updateModalSentenceInput.translation">
            <br> 
            <label>Sentence Audio</label>
            <br>
            <input type="text" name="title" class="form-control" v-bind:placeholder="updateModalSentence.audio" v-model="updateModalSentenceInput.audio">
            <br> 
          </div>
          <div class="modal-footer">
              <button type="button" class="btn btn-primary" @click="updatSentence()">Update</button>
...
export default {
  ...
  methods: {
    ...
    updateSentence(){
      ...
      axios.post(CONFIG.BACKEND_URL + '/sentence_popup/update', formData).then(response => {
        if(response.data.error.status === 100){
          let error = response.data.error.message
          if(error.word !== 'undefined'){
            this.errorMessage = error.word[0]
